...
def _parse_ssr_link(ssr_link):
    try:
        ...
        try:
            ...
            # 如果解码失败，返回空配置
            raise ValueError("Invalid SSR base64 encoding")
        ...
        raise ValueError(f"Error parsing SSR link: {e}")
...
def _convert_ssr_link(ssr_link):
    try:
...
if __name__ == "__main__":
    ...
    result = _convert_ssr_link(ssr_link)
    print(result)
